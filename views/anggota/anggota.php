  ...
  <main class="flex-grow max-w-6xl mx-auto mt-6 p-6 bg-white rounded-xl shadow-xl text-gray-800">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
      ...
      <div class="flex gap-2">
        <a href="tambah_anggota.php" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md shadow transition">+ Tambah Anggota</a>
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md" id="anggotaTable">
        ...
        <tbody>
        <?php
          $query = "SELECT id, nama, email, nomor, registered_at FROM anggota ORDER BY id ASC";
