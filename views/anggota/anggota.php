...
<body class="bg-gradient-to-r from-[#006298] to-[#55B9F3] min-h-screen font-sans text-white">
  ...
  <main class="max-w-6xl mx-auto mt-6 p-6 bg-white rounded-xl shadow-xl text-gray-800">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
      ...
      <input type="date" id="filterDate" class="px-4 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-[#006298] transition" />
  ...
  <script>
    ...
    document.getElementById("filterDate").addEventListener("change", function () {
      ...
      rows.forEach(row => {
        ...
        row.style.display = (tanggal === filter || filter === "") ? "" : "none";
      });
    });
